/* =============================================================
   ...
   Mobile: stacked vertically, band photo below text
...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="container relative z-10 w-full pt-20 md:pt-24 pb-16">
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          ...
          <div className="flex-1 w-full max-w-2xl">
            ...
            >
              ...
              <span
                ...
                style={{ backgroundColor: "oklch(0.52 0.24 25 / 0.5)" }}
              />
              <span
                className="font-mono-tech text-xs tracking-widest uppercase"
            ...
            {/* Tagline */}
            <p
              className={`font-body text-base md:text-lg lg:text-xl leading-relaxed mb-6 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
              style={{
            ...
            >
              ...
              <p className="font-display text-xl md:text-2xl tracking-wide" style={{ color: "oklch(0.87 0.02 80)" }}>
                GOD PLAYING DICE
              </p>
            ...
            >
              <button
                ...
                className="btn-crimson-pulse px-6 py-3 font-mono-tech text-xs sm:text-sm tracking-widest uppercase transition-all duration-200"
                style={{
              ...
              <button
                ...
                className="px-6 py-3 font-mono-tech text-xs sm:text-sm tracking-widest uppercase transition-all duration-200 border"
                style={{
                  borderColor: "oklch(0.87 0.02 80 / 0.3)",
                  color: "oklch(0.87 0.02 80)",
                }}
                onMouseEnter={(e) => {
                  (e.currentTarget as HTMLElement).style.borderColor = "oklch(0.87 0.02 80 / 0.7)";
                }}
                onMouseLeave={(e) => {
                  (e.currentTarget as HTMLElement).style.borderColor = "oklch(0.87 0.02 80 / 0.3)";
                }}
              >
                Our Story
              </button>
          ...
          {/* Right / Bottom: Band Photo */}
          <div
            className={`flex-shrink-0 w-full lg:w-auto transition-all duration-1000 ${visible ? "opacity-100 lg:translate-x-0" : "opacity-0 lg:translate-x-16"}`}
            style={{ transitionDelay: "0.4s" }}
          >
            <div className="relative mx-auto" style={{ maxWidth: "min(420px, 88vw)" }}>
              <div
                className="absolute inset-0"
                style={{
              ...
              <img
                ...
                style={{
                  ...
                  maxHeight: "clamp(240px, 55vw, 420px)",
                  objectFit: "cover",
                  objectPosition: "top",
                }}
              />
